...
import com.example.batches1.batches_view.batch_mix2;
import com.example.batches1.database.DatabaseHelper6;
import com.example.batches1.batches_present.batches_present_mix2;
import com.example.batches1.batches_absent.batches_absent_mix2;



public class view_batchesmix2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(view_batchesmix2.this, batch_mix2.class);
        ...
        viewonlyp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(view_batchesmix2.this, batches_present_mix2.class);
        ...
        viewonlyab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String name=myname.getText().toString();
                String da=date.getText().toString();
                Intent intent=new Intent(view_batchesmix2.this, batches_absent_mix2.class);
                intent.putExtra("NAME",name);
                intent.putExtra("DATE",da);
                startActivity(intent);
            }
