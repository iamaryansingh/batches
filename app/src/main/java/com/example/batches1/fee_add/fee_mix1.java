...
import com.example.batches1.fee_payview.fee_mix1payview;
import com.example.batches1.fee_view.fee_mix1view;

import java.text.SimpleDateFormat;
import java.util.Date;


public class fee_mix1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.length()!=0) {
                    ...
                    Toast.makeText(fee_mix1.this, "you must be putting something in the text field", Toast.LENGTH_LONG).show();
                }
        ...
        paid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(fee_mix1.this, fee_mix1payview.class);
        ...
        npaid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String da=date.getText().toString();
                Intent intent = new Intent(fee_mix1.this, fee_mix1view.class);
                intent.putExtra("DATETOPAY",da);
                startActivity(intent);
    ...
    public void AddData(String newEntry, String secondEntry,String third,String four){
        ...
        if(insertData==true){
            Toast.makeText(fee_mix1.this, "successfully entered", Toast.LENGTH_LONG).show();
        }
        else {
            Toast.makeText(fee_mix1.this, "something went wrong", Toast.LENGTH_LONG).show();
        }
        clearText();
    }
