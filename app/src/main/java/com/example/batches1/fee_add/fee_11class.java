...
import com.example.batches1.fee_view.fee_11view;
import com.example.batches1.fee_payview.fee_11payview;
import com.example.batches1.fee_view.fee_12view;


public class fee_11class extends AppCompatActivity {
    DatabaseHelper mydb;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.length() != 0) {
                    ...
                    Toast.makeText(fee_11class.this, "you must be putting something in the text field", Toast.LENGTH_LONG).show();
                }
        ...
        paid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(fee_11class.this, fee_12payview.class);
        ...
        npaid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String da = date.getText().toString();
                Intent intent = new Intent(fee_11class.this, fee_12view.class);
                intent.putExtra("DATETOPAY", da);
                startActivity(intent);
    ...
    public void AddData(String newEntry, String secondEntry, String third, String four) {
        ...
        if (insertData == true) {
            Toast.makeText(fee_11class.this, "successfully entered", Toast.LENGTH_LONG).show();
        } else {
            Toast.makeText(fee_11class.this, "something went wrong", Toast.LENGTH_LONG).show();
        }
        clearText();
    }
