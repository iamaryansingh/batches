...
import com.example.batches1.fee_payview.fee_10payview;
import com.example.batches1.fee_view.fee_10view;

import java.text.SimpleDateFormat;
import java.util.Date;


public class fee_10class extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.length()!=0) {
                    ...
                    Toast.makeText(fee_10class.this, "you must be putting something in the text field", Toast.LENGTH_LONG).show();
                }
        ...
        paid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(fee_10class.this, fee_10payview.class);
        ...
        npaid.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String da=date.getText().toString();
                Intent intent = new Intent(fee_10class.this, fee_10view.class);
                intent.putExtra("DATETOPAY",da);
                startActivity(intent);
    ...
    public void AddData(String newEntry, String secondEntry,String third,String four){
        ...
        if(insertData==true){
            Toast.makeText(fee_10class.this, "successfully entered", Toast.LENGTH_LONG).show();
        }
        else {
            Toast.makeText(fee_10class.this, "something went wrong", Toast.LENGTH_LONG).show();
        }
        clearText();
    }
