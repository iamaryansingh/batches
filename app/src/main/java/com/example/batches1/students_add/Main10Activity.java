...
import com.example.batches1.students_view.students_mix1view;


public class Main10Activity extends AppCompatActivity {
    EditText myname,phoneno;
    Button add,delete,modify,viewall;
    DatabaseHelper5 mydbsecond;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mydbsecond=new DatabaseHelper5(this);
        ...
        viewall.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Main10Activity.this, students_mix1view.class);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (myname.length()!=0) {
                    ...
                    Toast.makeText(Main10Activity.this, "you must be putting something in the text field", Toast.LENGTH_LONG).show();
                }
    ...
    public void AddData(String newEntry, String secondEntry){
        ...
        if(insertData==true){
            Toast.makeText(Main10Activity.this, "successfully entered", Toast.LENGTH_LONG).show();
        }
        else {
            Toast.makeText(Main10Activity.this, "something went wrong", Toast.LENGTH_LONG).show();
        }
        clearText();
    }
    ...
    public void DeleteData(){
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (deleterow>0){
                    Toast.makeText(Main10Activity.this, "successfuly deleted", Toast.LENGTH_LONG).show();
                }
                else {
                    Toast.makeText(Main10Activity.this, "something went wrong", Toast.LENGTH_LONG).show();
                }
