...
public class batches_present_mix1 extends AppCompatActivity {
    DatabaseHelper5 mydb2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mydb2 = new DatabaseHelper5(this);
        ...
        if(dataNEW.getCount()==0){
            Toast.makeText(batches_present_mix1.this, "empty data base", Toast.LENGTH_LONG).show();
        }
        else {
