...
public class attendence_mix2view extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (data.getCount() == 0) {
            Toast.makeText(attendence_mix2view.this, "empty data base", Toast.LENGTH_LONG).show();
        } else {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Toast.makeText(attendence_mix2view.this, "present", Toast.LENGTH_LONG).show();
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                String name=adapterView.getItemAtPosition(i).toString();
                Toast.makeText(attendence_mix2view.this, "absent", Toast.LENGTH_LONG).show();
